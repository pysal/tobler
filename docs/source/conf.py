...
sys.path.insert(0, os.path.abspath("../tobler/"))
...
html_theme_options = {
    ...
    "site_url": "https://pysal.org/tobler",
    "repo_url": "https://github.com/pysal/tobler/",
    "edit_uri": "blob/main/docs",
    "repo_name": "pysal/tobler",
    "features": [
        # "navigation.expand",
        # "navigation.tabs",
    ...
    "version_json": "https://pysal.org/tobler/versions.json",
}
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(tobler.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "tobler/%s#L%d-L%d" % find_source()  # noqa: UP031
    except Exception:
        filename = info["module"].replace(".", "/") + ".py"
    tag = "main" if "dev" in release else ("v" + release)
    return f"https://github.com/pysal/tobler/blob/{tag}/{filename}"
