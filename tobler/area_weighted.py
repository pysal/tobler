...
def area_tables_nlcd(source_df, target_df, raster, codes = [21, 22, 23, 24], force_crs_match = True):
    """
    ...
    res_union = append_profile_in_gdf(res_union_pre, raster = raster, force_crs_match = force_crs_match)
